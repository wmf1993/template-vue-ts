...
class RequestClient {
   ...
   * DELETE请求方法
   */
  public delete<T = any>(url: string, config?: RequestClientConfig): Promise<AxiosResponse<T>> {
   ...
   * GET请求方法
   */
  public get<T = any>(url: string, config?: RequestClientConfig): Promise<AxiosResponse<T>> {
   ...
   * 通用的请求方法
   */
  public async request<T>(url: string, config: RequestClientConfig): Promise<AxiosResponse<T>> {
    try {
